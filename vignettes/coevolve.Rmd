...
political_authority    -0.66      0.51 -1.92 -0.03 1.00     1520     1405
religious_authority    -0.77      0.57 -2.13 -0.03 1.00     1701     1104

Cross selection effects:
                                          Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority ⟶ religious_authority     2.32      1.00  0.50  4.40 1.00     1189     1140
religious_authority ⟶ political_authority     1.79      1.10 -0.38  4.08 1.00      702     1093     

Drift parameters:
                                             Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
sd(political_authority)                          1.97      0.83  0.25  3.57 1.01      339      704
sd(religious_authority)                          1.24      0.76  0.07  2.81 1.01      468     1033
cor(political_authority,religious_authority)     0.26      0.32 -0.45  0.78 1.00     1609     1552    

Continuous time intercept parameters:
                    Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority     0.22      0.94 -1.62  2.05 1.00     3521     1486
religious_authority     0.20      0.94 -1.58  2.08 1.00     3928     1323

Ordinal cutpoint parameters:
                       Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority[1]    -1.31      0.89 -3.01  0.42 1.00     2070     1576
political_authority[2]    -0.56      0.87 -2.20  1.15 1.00     2548     1539
political_authority[3]     1.64      0.89 -0.11  3.38 1.00     2819     1506
religious_authority[1]    -1.50      0.94 -3.39  0.31 1.00     2740     1564
religious_authority[2]    -0.81      0.92 -2.61  1.04 1.00     2828     1771
religious_authority[3]     1.60      0.94 -0.25  3.50 1.00     2679     1605
```
...
Autoregressive selection effects:
             Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
brain_weight    -0.42      0.35 -1.28 -0.02 1.00     3202     1693
group_size      -0.77      0.53 -1.98 -0.05 1.00     2888     2135

Cross selection effects:
                          Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
brain_weight ⟶ group_size     0.49      0.72 -1.03  1.75 1.00     1257     1905
group_size ⟶ brain_weight     0.60      0.94 -1.33  2.36 1.00     2152     2647

Drift parameters:
                             Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
sd(brain_weight)                 1.09      0.22  0.69  1.58 1.01     1146      977
sd(group_size)                   0.64      0.42  0.03  1.56 1.00      515      709
cor(brain_weight,group_size)     0.04      0.30 -0.56  0.61 1.00     3151     2692

Continuous time intercept parameters:
             Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
brain_weight    -0.27      0.83 -1.89  1.35 1.00     2744     2424
group_size      -0.83      0.76 -2.31  0.71 1.00     3303     2975

Shape parameters:
             Estimate Est.Error 2.5%  97.5% Rhat Bulk_ESS Tail_ESS
brain_weight    64.93     69.13 4.87 246.45 1.03      200      693
group_size       5.28     11.56 1.45  20.73 1.00      490      470
```
...
Autoregressive selection effects:
  Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
x    -2.61      0.82 -4.26 -1.01 1.00     7592     4142
y    -2.13      0.77 -3.68 -0.65 1.00     6362     2860

Cross selection effects:
      Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
x ⟶ y     0.04      0.94 -1.80  1.91 1.00    10656     6235
y ⟶ x     0.10      0.92 -1.68  1.89 1.00    10828     5315

Drift parameters:
         Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
sd(x)        1.43      0.11  1.24  1.67 1.00    12263     6139
sd(y)        1.33      0.11  1.14  1.56 1.00    11565     6389
cor(x,y)    -0.07      0.10 -0.26  0.14 1.00    11149     6050

Continuous time intercept parameters:
  Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
x    -0.08      0.70 -1.42  1.28 1.00     5845     5863
y     0.09      0.68 -1.25  1.46 1.00     6818     5435

Group-level hyperparameters:
         Estimate Est.Error 2.5% 97.5% Rhat Bulk_ESS Tail_ESS
sd(x)        0.96      0.16 0.71  1.31 1.00     2630     3711
sd(y)        0.87      0.15 0.62  1.21 1.00     2695     4724
cor(x,y)     0.91      0.06 0.74  0.98 1.00     3959     5387
```
...
Autoregressive selection effects:
                    Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority    -0.64      0.51 -1.85 -0.02 1.00     8411     4774
religious_authority    -0.69      0.54 -2.01 -0.03 1.00     8219     5223

Cross selection effects:
                                          Estimate Est.Error 2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority ⟶ religious_authority     2.03      1.03 0.36  4.37 1.00     3576     5132
religious_authority ⟶ political_authority     2.11      1.06 0.32  4.44 1.00     3565     5400

Drift parameters:
                                             Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
sd(political_authority)                          1.12      0.82  0.04  2.96 1.00     1170     4039
sd(religious_authority)                          0.90      0.69  0.03  2.51 1.00     2071     3817
cor(political_authority,religious_authority)     0.04      0.33 -0.60  0.65 1.00     6274     5385    

Continuous time intercept parameters:
                    Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority     0.35      0.91 -1.46  2.14 1.00    17120     5503
religious_authority     0.42      0.91 -1.38  2.19 1.00    13400     5360

Ordinal cutpoint parameters:
                       Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority[1]    -1.54      0.92 -3.39  0.21 1.00    10680     6328
political_authority[2]    -0.81      0.89 -2.59  0.93 1.00    10603     6539
political_authority[3]     1.92      0.95  0.15  3.92 1.00    12221     6801
religious_authority[1]    -1.83      0.88 -3.58 -0.12 1.00     9529     5674
religious_authority[2]    -1.15      0.86 -2.88  0.54 1.00    10386     6031
religious_authority[3]     1.67      0.95 -0.08  3.68 1.00     7619     6205
```
...
Autoregressive selection effects:
                    Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority    -0.70      0.55 -2.03 -0.03 1.00     2594     2023
religious_authority    -0.78      0.58 -2.17 -0.03 1.00     2717     1336

Cross selection effects:
                                          Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority ⟶ religious_authority     1.91      1.25 -0.67  4.32 1.00     1213     1854
religious_authority ⟶ political_authority     1.57      1.29 -1.04  4.07 1.00     1339     1642     

Drift parameters:
                                             Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
sd(political_authority)                          1.33      0.75  0.07  2.85 1.00      712     1186
sd(religious_authority)                          0.93      0.63  0.04  2.33 1.00     1005     1803
cor(political_authority,religious_authority)     0.14      0.33 -0.54  0.71 1.00     3019     2986    

Continuous time intercept parameters:
                    Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority     0.35      0.94 -1.48  2.20 1.00     5567     3062
religious_authority     0.32      0.96 -1.63  2.19 1.00     5041     2488

Ordinal cutpoint parameters:
                       Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority[1]    -1.51      0.99 -3.39  0.52 1.00     3128     2999
political_authority[2]    -0.79      0.98 -2.63  1.20 1.00     3096     3053
political_authority[3]     1.32      1.02 -0.68  3.36 1.00     2333     2702
religious_authority[1]    -1.69      1.00 -3.59  0.30 1.00     2260     1931
religious_authority[2]    -1.01      0.99 -2.98  0.99 1.00     2335     2259
religious_authority[3]     1.48      1.03 -0.46  3.59 1.00     1966     2318

Gaussian Process parameters for distances:
                          Estimate Est.Error 2.5% 97.5% Rhat Bulk_ESS Tail_ESS
rho(political_authority)      0.07      0.05 0.02  0.19 1.00      774      749
rho(religious_authority)      0.06      0.06 0.02  0.24 1.00      592      465
sdgp(political_authority)     1.99      1.16 0.33  4.86 1.00     1195     1083
sdgp(religious_authority)     2.59      1.43 0.43  6.05 1.00     1067     1225
```
