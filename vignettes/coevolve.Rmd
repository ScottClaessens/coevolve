...
Chain 4 finished in 6515.4 seconds.
Chain 3 finished in 6908.3 seconds.
Chain 2 finished in 6988.3 seconds.
Chain 1 finished in 6996.0 seconds.

All 4 chains finished successfully.
Mean chain execution time: 6852.0 seconds.
Total execution time: 6996.5 seconds.
```
...
political_authority    -0.64      0.51 -1.92 -0.02 1.00     3170     2226
religious_authority    -0.67      0.53 -1.99 -0.02 1.00     2660     2529

Cross selection effects:
                                          Estimate Est.Error 2.5% 97.5% Rhat Bulk_ESS
political_authority ⟶ religious_authority     2.85      1.05 0.90  5.07 1.00     1700
religious_authority ⟶ political_authority     2.54      1.06 0.49  4.71 1.00     1794
                                          Tail_ESS
political_authority ⟶ religious_authority     2022
religious_authority ⟶ political_authority     2221

Drift scale parameters:
                    Estimate Est.Error 2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority     1.48      0.76 0.15  3.12 1.00     1933     1759
religious_authority     1.19      0.75 0.07  2.83 1.00     1572     1580

Continuous time intercept parameters:
                    Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority     0.10      0.94 -1.75  1.95 1.00     7703     2711
religious_authority     0.15      0.94 -1.73  1.99 1.00     6868     2765

Ordinal cutpoint parameters:
                       Estimate Est.Error  2.5% 97.5% Rhat Bulk_ESS Tail_ESS
political_authority[1]    -1.01      0.85 -2.64  0.65 1.00     4937     2852
political_authority[2]    -0.33      0.84 -1.91  1.30 1.00     5065     2896
political_authority[3]     1.63      0.87  0.01  3.35 1.00     4344     3269
religious_authority[1]    -1.33      0.88 -3.05  0.40 1.00     5193     3044
religious_authority[2]    -0.69      0.87 -2.38  1.03 1.00     5282     2994
religious_authority[3]     1.59      0.90 -0.10  3.42 1.00     4851     2965
```
...
<img src="authority-delta-theta-1.jpeg" width="60%" style="display: block; margin: auto;" />
...
<img src="authority-flowfield-1.jpeg" width="60%" style="display: block; margin: auto;" />
...
<img src="authority-selection-gradient-1.jpeg" width="60%" style="display: block; margin: auto;" />
...
**coevolve** supports several more response distributions.
...
than remove taxa if they have any missing data, the `coev_fit()` function will
remove only taxa if they have missing data for *all* coevolving variables. If
...
```
             species body_weight brain_weight group_size
1    Alouatta_caraya    5596.653     52.71988   6.683333
2  Alouatta_palliata    6358.997     50.90798  15.548438
3     Alouatta_pigra    8940.000     52.96550   5.933333
4 Alouatta_seniculus    6247.360     56.57013   6.965000
5       Aotus_azarai    1073.190     21.41265   3.000000
6    Aotus_lemurinus     869.980     16.78196   3.500000
```
...
```
Error: Some variable names are not valid column names in the data.
```
