---
title: "Accounting for repeated observations"
output:
...
vignette: >
  %\VignetteIndexEntry{Accounting for repeated observations}
...
Chain 3 finished in 265.7 seconds.
Chain 2 finished in 368.7 seconds.
Chain 4 finished in 369.0 seconds.
Chain 1 finished in 378.3 seconds.

All 4 chains finished successfully.
Mean chain execution time: 345.4 seconds.
Total execution time: 378.4 seconds.
```
...
## Limitations of repeated observations models
...
In addition, note that models with repeated observations for mixtures of
continuous and non-continuous traits are currently considered experimental and
