test_that("coev_plot_pred_series() produces expected errors and output", {
  ...
  expect_no_error(SW(coev_plot_pred_series(m1, intervention_values = list(v = NA, w = 0, x = 0, y = 0))))
  ...
  expect_no_error(SW(coev_plot_pred_series(m1, eta_anc = list(v = 0, w = 0, x = 0, y = 0))))
