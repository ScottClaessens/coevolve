test_that("coev_pred_series() produces expected errors and output", {
  ...
  expect_no_error(SW(coev_pred_series(m1, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m2, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m3, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m4, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m5, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m6, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m7, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m8, ndraws = 1)))
  expect_no_error(SW(coev_pred_series(m9, ndraws = 1)))
