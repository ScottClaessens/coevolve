test_that("coev_pred_series() produces expected errors and output", {
  ...
  expect_no_error(sw(coev_pred_series(m11)))
  ...
  expect_no_error(sw(coev_pred_series(m11, stochastic = TRUE)))
  ...
  expect_no_error(sw(coev_pred_series(m11, ndraws = 1)))
  expect_no_error(
    sw(
      coev_pred_series(
  ...
  expect_no_error(sw(coev_pred_series(m11, eta_anc = list(x = 0, y = 0))))
